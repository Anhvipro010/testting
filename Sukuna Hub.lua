	...
	_G.ColorMethod = Color3.fromRGB(14, 255, 14)
...
local Reduisceen = Instance.new("ScreenGui")
	...
	local TextButton77 = Instance.new("TextButton")
	   ...
	   --[[ local TextButton7 = Instance.new("TextButton")
		...
		SearchStroke2.Color = _G.ColorMethod
	...
	local IMGNAME = Instance.new("ImageLabel")
		...
		IMGNAME.Image = "rbxassetid://1"
			...
			NameReal.BackgroundTransparency = 1
			NameReal.BorderSizePixel = 0
			NameReal.Position = UDim2.new(0.291, -5, 0.04, 0)
			NameReal.AnchorPoint = Vector2.new(0.5, 0.5)
			NameReal.Size = UDim2.new(0, 136, 0, 34)
			NameReal.Font = Enum.Font.GothamBold
			NameReal.Text = "version-21bedf9513a74867"
		...
		--        TextButton_3_Toggle.BorderColor3 = _G.ColorMethod
			...
			OMF.MouseButton1Down:Connect(
				...
				function items:Label(text,image)
					...
					ImageLabel_gx.Image = "http://www.roblox.com/asset/?id="..tostring(1)
...
Main:Label("General")
	...
	Main:Drop("Weapon",false,{"Melee","Sword","Gun","Fruit"},function(value)
...
if typeof(y) == "table" then
	pcall(function()
		...
		y.activeController.focusStart = 155555599999.9999
   ...
   Main:Toggle("Auto Seacond Sea",false,function(value)
   ...
   Main:Toggle("Auto Fruit Mastery",false,function(value)

   end)
   
   Main:Toggle("Auto Gun Mastery",false,function(value)

   end)
   
   Main:Slider("Health %",false,false,0,100,25,25,false,10,function(value)
			_G.Point = value
  end)
   ...
   Main2:Toggle("Gun",false,function(value)
      ...
      Main2:Toggle("Fruit",false,function(value)

   end)
   
    local Main1 = Tap1:newpage()
    
    Main1:Label("Saber")
    
    Main1:Toggle("Saber",false,function(value)

   end)
   
       Main1:Toggle("Hop Saber",false,function(value)

   end)
   
   Main1:Label("Pole")
   
       Main1:Toggle("Pole",false,function(value)

   end)
   
       Main1:Toggle("Hop Pole",false,function(value)

   end)
   
   Main1:Label("Chest")
   
   Main1:Toggle("Auto Chest",false,function(va)
   AutoFarmChest = va
   end)
