...
local Window = OrionLib:MakeWindow({Name = "Edward Newgate Hub", HidePremium = false, IntroText = "EdwardNewgateHub Library", SaveConfig = true, ConfigFolder = "Edward Newgate Hub"})
